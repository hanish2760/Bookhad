    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Book newb=new Book(title.getText().toString(),author.getText().toString());
                db.push().setValue(newb);
                Toast.makeText(Home2.this,"Book Added to your Wishlist",Toast.LENGTH_LONG).show();
                startActivity(new Intent(Home2.this,Mywishlist.class));
            }
        });
...
//        so=(Button)findViewById(R.id.button2);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ActivityCompat.requestPermissions(Home2.this, new
        ...
        switch (requestCode) {
            case REQUEST_WRITE_PERMISSION:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(Home2.this, "Permission Denied!", Toast.LENGTH_SHORT).show();
                }
        }
    }
    @Override
